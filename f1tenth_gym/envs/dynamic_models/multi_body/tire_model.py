...
def formula_longitudinal(kappa, gamma, F_z, params):
    ...
    tire_p_cx1 = params[56]  # shape factor Cfx
    tire_p_dx1 = params[57]  # peak longitudinal friction
    tire_p_dx3 = params[58]  # friction variation with camber
    tire_p_ex1 = params[59]  # curvature factor Efx
    tire_p_kx1 = params[60]  # slip stiffness Kfx/Fz
    tire_p_hx1 = params[61]  # horizontal shift Shx
    tire_p_vx1 = params[62]  # vertical shift Svx/Fz
...
def formula_lateral(alpha, gamma, F_z, params):
    ...
    tire_p_cy1 = params[68]  # shape factor Cfy
    tire_p_dy1 = params[69]  # lateral friction Muy
    tire_p_dy3 = params[70]  # friction variation with camber²
    tire_p_ey1 = params[71]  # curvature factor Efy
    tire_p_ky1 = params[72]  # stiffness Kfy/Fz
    tire_p_hy1 = params[73]  # horizontal shift Shy
    tire_p_hy3 = params[74]  # shift variation with camber
    tire_p_vy1 = params[75]  # vertical shift Svy/Fz
    tire_p_vy3 = params[76]  # Svy/Fz variation with camber
...
def formula_longitudinal_comb(kappa, alpha, F0_x, params):
    ...
    tire_r_bx1 = params[63]  # slope for Fx reduction
    tire_r_bx2 = params[64]  # Fx slope variation w/ kappa
    tire_r_cx1 = params[65]  # shape factor for Fx reduction
    tire_r_ex1 = params[66]  # curvature for Fx reduction
    tire_r_hx1 = params[67]  # shift for Fx reduction
...
def formula_lateral_comb(kappa, alpha, gamma, mu_y, F_z, F0_y, params):
    ...
    tire_r_by1 = params[77]  # slope for Fy reduction
    tire_r_by2 = params[78]  # slope variation with alpha
    tire_r_by3 = params[79]  # alpha shift in Fy slope
    tire_r_cy1 = params[80]  # shape factor for Fy reduction
    tire_r_ey1 = params[81]  # curvature for Fy reduction
    tire_r_hy1 = params[82]  # shift for Fy reduction
    tire_r_vy1 = params[83]  # kappa-induced side force
    tire_r_vy3 = params[84]  # side force variation w/ camber
    tire_r_vy4 = params[85]  # variation w/ alpha
    tire_r_vy5 = params[86]  # variation w/ kappa
    tire_r_vy6 = params[87]  # variation w/ atan(kappa)
